...
class Motor:
    def __init__(self):
        ...
        self.MAX_SPEED = [100,200,200] ## 2000 seems to be max steps/sec before encoder falls over
        ...
        self.ENCODER_FACTOR = [1748.319,0,0] #Sets vertical motion to cm and rotation to degrees
        ...
        self.encoderWrap = [0,0,1677719] # Encoder wrap number
    ...
    def SendToHome(self, event, axis):
        ...
        print("Axis", axis," has set current position as home")
        self.isHome[axis] = 1
